...
public class RecordPortraitFragment extends Fragment {

    public static final String TAG = RecordPortraitFragment.class.getSimpleName();
    ...
    public static RecordPortraitFragment newInstance() {
        return new RecordPortraitFragment();
    }
