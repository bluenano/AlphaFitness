...
public class RecordLandscapeFragment extends Fragment {

    public static final String TAG = RecordLandscapeFragment.class.getSimpleName();
    ...
    public void updateAvgRate(float newRate) {
        mAvgRate.setText(convertMinPerMiToTimeString(newRate));
    }

    public void updateMinRate(float newRate) {
        mMinRate.setText(convertMinPerMiToTimeString(newRate));
    }

    public void updateMaxRate(float newRate) {
        mMaxRate.setText(convertMinPerMiToTimeString(newRate));
    }
    ...
    public static RecordLandscapeFragment newInstance() {
    ...
    private String convertMinPerMiToTimeString(float rate) {
